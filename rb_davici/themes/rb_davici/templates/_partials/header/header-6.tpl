...
* @author PrestaShop SA <contact@prestashop.com>
  ...
  *}
  ...
  <nav class="header-nav header-nav-1 style-2">
  ...
  <div class="header-desktop header-6">
      ...
      <div class="container container-large">
        <div class="row header-flex">
          <div class="header-left col-xl-2 col-lg-2 col-md-3 col-sm-3 col-xs-12 col-sp-12">
            ...
            <h1>
              <a href="{$urls.base_url}">
                <img class="logo" src="{$urls.base_url}themes/rb_davici/assets/img/logo-white.png" alt="{$shop.name}">
              </a>
            </h1>
            {else}
            <a href="{$urls.base_url}">
          ...
          <div class="header-right col-xl-5 col-lg-5 col-md-5 col-sm-5 col-xs-10 col-sp-10">
            <div class="header-page-link">
              <div class="phone ship hidden-lg-down hidden-md-down"> 
                <i class="icon-delivery-truck"></i>
                <div class="content"> 
                  <label class="font-bold">{l s='Free shipping' d='Shop.Theme.Global'}</label> 
                  <span>{l s='over order $120 ' d='Shop.Theme.Global'}</span>
                </div>
              </div>
        ...
        <div class="row header-flex">
          ...
          <div class="header-w-right col-xl-9 col-lg-8 col-md-8 col-sm-8 col-xs-4 col-sp-4">
            ...
            <div class="list-link-menu hidden-lg-down">
              <ul>
                <li><a href="#">{l s='Our store' d='Shop.Theme.Global'}</a></li>
                <li><a href="#">{l s='Buy davici' d='Shop.Theme.Global'}</a></li>
              </ul>
            </div>
          </div>
        </div>
