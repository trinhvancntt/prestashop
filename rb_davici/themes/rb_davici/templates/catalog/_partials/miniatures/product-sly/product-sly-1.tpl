 ...
 *}
<article
  class="product-miniature js-product-miniature item-product {if isset($config)} {$config}{else if Configuration::get('RBTHEMEDREAM_COL_PRODUCT_LIST') != ''} {Configuration::get('RBTHEMEDREAM_COL_PRODUCT_LIST')}{else} col-md-3{/if}"
