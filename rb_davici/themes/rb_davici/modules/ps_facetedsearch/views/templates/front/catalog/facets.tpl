...
{if $displayedFacets|count}
  <div id="search_filters">
    {block name='facets_title'}
      <p class="block-title h6 hidden-sm-down">{l s='Filter By' d='Shop.Theme.Actions'}</p>
    {/block}
    ...
    {foreach from=$displayedFacets item="facet"}
      <section class="facet clearfix">
        <p class="h6 facet-title hidden-sm-down"><i class="fa fa-angle-double-right" aria-hidden="true"></i> {$facet.label}</p>
