...
if ($the_slidertype == 'hero') {
    ...
    $exists = RbSliderSlide::isSlideByID($active_slide);
...
<div id="slide_selector" class="slide_selector editor_buttons_wrapper  postbox unite-postbox" style="max-width:100% !important;">
        ...
        <ul class="list_slide_links">
            ...
            <li class="<?php echo $staticclass; ?> eg-drag-disabled">
                ...
                if (!$slide->isStaticSlide()) {
                    ...
                    ?>
                    <a href="<?php echo self::getViewUrl(RbSliderAdmin::VIEW_SLIDE, "id=static_$sID");
                   ...
                   ?>
                    ...
                    <div class="slide-link-content alwaysbluebg" style="background:#3498DB !important; color:#fff">
                        <span class="slide-link" style="width:100%;text-align: center;"><?php echo $modules->l("Static / Global Layers"); ?></span>
                    </div>
                    <?php
                    if (!$slide->isStaticSlide()) {
                ...
                if ($slide->isStaticSlide()) {
                    ...
                    RbGlobalObject::setVar('all_slides', $all_slides);

                    ?>
                    <span style="position:absolute; top:13px;left:0px; text-align: center">
                        <span class="setting_text_3"><?php echo $modules->l("Show Layers from Slide:");

                    ?></span>
                        <select name="rb_show_the_slides">
                            <option value="none">---</option>
                                ...
                                <option value="<?php echo $c_slide->getID();
                                        ...
                                        ?>"><?php echo Tools::stripslashes(RbSliderFunctions::getVal($c_params, 'title', 'Slide')) . ' (ID: ' . $c_slide->getID() . ')';
            ...
            foreach ($arrSlides as $t_slide) {
                ...
                if ($c_bgType == 'image' || $c_bgType == 'streamvimeo' || $c_bgType == 'streamyoutube' || $c_bgType == 'streaminstagram') {
                    switch ($slider_type) {
                        case 'posts':
                        case 'specific_posts':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/post.png';
                            break;
                        case 'woocommerce':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/wc.png';
                            break;
                        case 'facebook':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/fb.png';
                            break;
                        case 'twitter':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/tw.png';
                            break;
                        case 'instagram':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/ig.png';
                            break;
                        case 'flickr':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/fr.png';
                            break;
                        case 'youtube':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/yt.png';
                            break;
                        case 'vimeo':
                            $c_urlImageForView = _MODULE_DIR_ . 'rbthemeslider/views/img/images/sources/vm.png';
                            break;
                    }
                }
                ...
                $titleclass = '';
                $c_topclass = '';
                $urlEditSlide = self::getViewUrl(RbSliderAdmin::VIEW_SLIDE, "id=$slidelistID");
    ...
    if ($slidelistID != $slideID && !in_array($slideID, $arrChildrenIDs)) {
        ...
        ?>
                                <a class="slide-link-toolbar-button slide-moveto" href="#"><span class=""><i class="eg-icon-forward"></i><span><?php echo $modules->l("Copy / Move");
        ...
        ?></span></span></a>
                ...
                ?>
                            <a class="slide-link-toolbar-button slide-duplicate" href="#"><span class=""><i class="eg-icon-picture"></i><span><?php echo $modules->l("Duplicate");

                ?></span></span></a>
                            <a class="slide-link-toolbar-button slide-add-as-template" href="#"><span class=""><i class="eg-icon-menu"></i><span><?php echo $modules->l("Add to Templates");

                ?></span></span></a>
                            <a class="slide-link-toolbar-button slide-remove" href="#"><span class=""><i class="eg-icon-trash"></i><span><?php echo $modules->l("Delete");
...
?>
            <li class="eg-drag-disabled">
                <a href="javascript:void(0);" class="add_slide">
                    ...
                    <div class="slide-link-content">
                        <span class="slide-link" style="width:100%;text-align: center;font-weight:600;"><?php echo $modules->l("Add Slide"); ?></span>
                    </div>
                </a>
                <div class="slide-link-content">
                    <div class="slide-link-toolbar">
                        <a id="link_add_slide" href="javascript:void(0);" class="slide-link-toolbar-button"><span class="slide-add"><i class="eg-icon-picture-1" style="margin-right:5px"></i><span><?php echo $modules->l("Add Blank Slide"); ?></span></span></a>
                        <a id="link_add_bulk_slide" href="javascript:void(0);" class="slide-link-toolbar-button"><span class="slide-add"><i class="eg-icon-picture" style="margin-right:5px"></i><span><?php echo $modules->l("Add Bulk Slides"); ?></span></span></a>								
                        <a id="rs_copy_slide_from_slider" href="javascript:void(0);" class="slide-link-toolbar-button">
                            <span class="slide-copy-from-slider"><i class="eg-icon-menu" style="margin-right:5px"></i><span><?php echo $modules->l("Add from Template"); ?></span></span>
                        </a>
                    </div>
                    <span class="slide-link" style="text-align:center">
<?php echo $modules->l("Add Slide"); ?>
                    </span>
                </div>
...
<script>
    jQuery("document").ready(function() {
        ...
        jQuery('.slidetitleinput').on("change", function() {
            ...
            titleinp.blur();
            if (UniteAdminRb.sanitize_input(slide_title) == '') {
                alert('<?php echo $modules->l('Slide name should not be empty'); ?>');
                return false;
            }

            var data = {slideID: slide_id, slideTitle: slide_title};

            UniteAdminRb.ajaxRequest('change_slide_title', data, function(response) {
            });
