...
class AdminRbthemesliderNavigationController extends ModuleAdminController
{
    ...
    public function setMedia()
    {
        ...
        $this->addJS($path_js . '/js/rb_admin.js');
    ...
    public function displayStats()
    {
        ...
        $this->context->smarty->assign(array(
            ...
            'ajaxurl' => Context::getContext()->link->getAdminLink('AdminRbthemesliderAjax'),
            'ajaxurl_ext' => urlencode(htmlspecialchars_decode(adminUrl()))
        ));
