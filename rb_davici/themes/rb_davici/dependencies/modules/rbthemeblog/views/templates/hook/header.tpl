...
<meta property="fb:admins" content="{Configuration::get('RBTHEMEBLOG_BLOG_FACEBOOK_MODERATOR')|intval}"/>
<meta property="fb:app_id" content="{Configuration::get('RBTHEMEBLOG_BLOG_FACEBOOK_APP_ID')|intval}"/>