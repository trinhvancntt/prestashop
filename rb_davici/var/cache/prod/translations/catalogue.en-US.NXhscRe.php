...
Thanks for your patience.',
  ...
  array (
    ...
    '[1]%fax%[/1]' => '[1]%fax%[/1]',
    '[1]%email%[/1]' => '[1]%email%[/1]',
    'Join our cosmetics news & offers' => 'Join our cosmetics news & offers',
    'Our Products' => 'Our Products',
    'Search' => 'Search',
    ...
    'Subscribe' => 'Subscribe',
    'Our store' => 'Our store',
    'Create a captivating CV or résumé in no time! MyCareer has all the elements you may need.' => 'Create a captivating CV or résumé in no time! MyCareer has all the elements you may need.',
    '%copyright% %year% - Ecommerce software by %prestashop%' => '%copyright% %year% - Ecommerce software by %prestashop%',
    '100% authentic products, quick delivery, fast online support, and free gifts almost with every order.' => '100% authentic products, quick delivery, fast online support, and free gifts almost with every order.',
    'Language:' => 'Language:',
    'Currency:' => 'Currency:',
    'Winter-Season Sale Up To 25% OFF Products' => 'Winter-Season Sale Up To 25% OFF Products',
    'Active filters' => 'Active filters',
    '(no filter)' => '(no filter)',
    'Grid' => 'Grid',
    'List' => 'List',
