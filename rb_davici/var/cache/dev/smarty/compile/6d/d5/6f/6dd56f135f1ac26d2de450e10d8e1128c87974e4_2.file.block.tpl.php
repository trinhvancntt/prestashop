...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  ...
  'unifunc' => 'content_60846a115c7d07_83419175',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '6dd56f135f1ac26d2de450e10d8e1128c87974e4' => 
    array (
...
function content_60846a115c7d07_83419175 (Smarty_Internal_Template $_smarty_tpl) {
if (isset($_smarty_tpl->tpl_vars['block']->value) && $_smarty_tpl->tpl_vars['block']->value && $_smarty_tpl->tpl_vars['block']->value['enabled']) {?>    
    <div class="rb_block rb_block_type_<?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( strtolower($_smarty_tpl->tpl_vars['block']->value['block_type']),'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
 <?php if (!$_smarty_tpl->tpl_vars['block']->value['display_title']) {?>rb_hide_title<?php }?>">
        <h4 <?php if (Configuration::get('RBTHEMEDREAM_TEXTTITLE_FONT_SIZE')) {?> style="font-size:<?php echo htmlspecialchars(intval(Configuration::get('RBTHEMEDREAM_TEXTTITLE_FONT_SIZE')), ENT_QUOTES, 'UTF-8');?>
...
" <?php if (Configuration::get('RBTHEMEDREAM_TEXTTITLE_FONT_SIZE')) {?> style="font-size:<?php echo htmlspecialchars(intval(Configuration::get('RBTHEMEDREAM_TEXTTITLE_FONT_SIZE')), ENT_QUOTES, 'UTF-8');?>
px"<?php }?>><?php }
...
"/>
                                        ...
                                        <?php if (isset($_smarty_tpl->tpl_vars['block']->value['display_mnu_name']) && $_smarty_tpl->tpl_vars['block']->value['display_mnu_name']) {?>
                                            <span class="rb_item_name"><?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['manufacturer']->value['label'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</span>
                                        <?php }?>
                                    <?php } else { ?>
...
" />
                                        ...
                                        <?php if (isset($_smarty_tpl->tpl_vars['block']->value['display_suppliers_name']) && $_smarty_tpl->tpl_vars['block']->value['display_suppliers_name']) {?>
                                            <span class="rb_item_name"><?php echo htmlspecialchars(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['supplier']->value['label'],'html','UTF-8' )), ENT_QUOTES, 'UTF-8');?>
</span>
                                        <?php }?>
                                    <?php } else { ?>
