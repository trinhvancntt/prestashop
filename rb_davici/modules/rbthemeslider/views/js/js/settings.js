...
*/
var UniteSettingsRb = new function(){
	...
	this.getSettingsObject = function(formID){		
		...
		for(var i=0; i<len; i++){
			...
			type = element.type;
			if(jQuery(element).hasClass("ps-editor-area"))
				type = "editor";
	...
	var initImageSearch = function(){
		...
		jQuery(".button-image-select").click(function(){
			...
			UniteAdminRb.openAddImageDialog("Choose Image",function(urlImage, imageID){
				//update input:
				jQuery("#"+settingID).val(urlImage);
				
				//update preview image:
				var urlShowImage = UniteAdminRb.getUrlShowImage(imageID,100,70,true);
		...
		jQuery(".button-image-select-video").click(function(){
			...
			UniteAdminRb.openImageDialogForVideo("Choose Image",function(urlImage, imageID){
				
				//update input:
				jQuery("#input_video_preview").val(urlImage);				
				//update preview image:
				var urlShowImage = UniteAdminRb.getUrlShowImage(imageID,200,150,true);                                
...
var RbSliderSettings = UniteSettingsRb;
