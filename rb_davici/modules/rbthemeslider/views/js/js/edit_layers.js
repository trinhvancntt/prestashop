...
jQuery(document).ready(function(){
    UniteLayersRb.setGlobalAction(ps.template( "rs-action-layer-wrap" ));
});
...
var UniteLayersRb = new function(){
    ...
    ***************************************/
    ...
    t.init = function(slideTime){
        ...
        jQuery('select[name="rb_show_the_slides"]').change(function(){
        ...
        jQuery('.rs-slide-device_selector').click(function(){
            if(rb_adv_resp_sizes == false) return;
                    
            var changeto = jQuery(this).data('val');
            layout = changeto;
            
            jQuery('.tp-bgimg.defaultimg, #divLayers').css({
                    width:rb_sizes[changeto][0], 
                    height:rb_sizes[changeto][1]
                });
                    
            if (__slidertype!="auto") {
                jQuery('#divbgholder').css({minWidth:rb_sizes[changeto][0], maxWidth:"100%", marginLeft:"auto",marginRight:"auto"});
                jQuery('#divbgholder').css({minHeight:rb_sizes[changeto][1],height:rb_sizes[changeto][1]});
                jQuery('.slotholder .tp-bgimg.defaultimg').css({minWidth:rb_sizes[changeto][0], maxWidth:"100%" });
                jQuery('.tp-bgimg.defaultimg').css({
                    width:"100%"                    
                })
            } else {
                
                jQuery('#divbgholder').css({minWidth:rb_sizes[changeto][0], maxWidth:rb_sizes[changeto][0], marginLeft:"auto",marginRight:"auto"});
                jQuery('#divbgholder').css({minHeight:rb_sizes[changeto][1],height:rb_sizes[changeto][1]});
                jQuery('.slotholder .tp-bgimg.defaultimg').css({minWidth:rb_sizes[changeto][0], maxWidth:rb_sizes[changeto][0] })

            }           
            
            jQuery('#divLayers-wrapper').css('height', rb_sizes[changeto][1] + 1);
        ...
        jQuery('.copy-from-idle').click(function(){
            ...
            if(confirm(rb_lang.copy_styles_to_idle_from_hover)){
        ...
        jQuery('.copy-from-hover').click(function(){
            if(confirm(rb_lang.copy_styles_to_hover_from_idle)){
                var layer = t.getCurrentLayer();
            ...
            if(layer !== null){
                ...
                switch(layer.type){
                    ...
                    case 'video':
                        ...
                        //open video dialog
                        UniteAdminRb.openVideoDialog(function(videoData){
                            //update video layer
                    ...
                    break;
                    case 'image':
                        UniteAdminRb.openAddImageDialog(rb_lang.select_layer_image,function(urlImage){
                            var objData = {};
        ...
        jQuery('body').on('click',".button_delete_layer, #button_delete_layer", function(){
            ...
            if(confirm(rb_lang.delete_layer)){
            ...
            if(set_anim == 'out' && anim_handle == 'auto'){ //check if masking is enabled for in-animation, if yes do it here, too
                if(jQuery('#masking-start')[0].checked){
                    if(jQuery('#masking-start')[0].checked == true){
                        ...
                        RbSliderSettings.onoffStatus(jQuery('#masking-end'));  
        ...
        jQuery('#layer_caption').change(function(){
            ...
            if(UniteCssEditorRb.checkIfHandleExists(jQuery(this).val())){
        ...
        jQuery('.save-current-animin, .save-current-animout').click(function() {
            ...
            if(handle !== 'custom'){
                for(var key in initLayerAnimsDefault){
                    if(key === handle){
                        alert(rb_lang.cant_modify_default_anims);
                        return false;
                    }
                }
            }
            ...
            if(handle == 'custom'){
                ...
                jQuery('#dialog_save_animation').dialog({
                    ...
                    buttons:{
                        'Save':function(){
                            ...
                            var new_handle = UniteAdminRb.sanitize_input(new_name);
                            
                            var do_insert = true;
                            for(var key in initLayerAnimsDefault){
                                //if(key == new_handle){
                                if(initLayerAnimsDefault[key]['handle'] == new_handle){
                                    alert(rb_lang.name_is_default_animations_cant_be_changed);
                                    return false;
                                }
                            }
                            ...
                            if(do_insert === true){
                                ...
                                if(confirm(rb_lang.override_animation)){
                ...
                if(confirm(rb_lang.overwrite_animation)){
                ...
                buttons:{
                    'Save':function(){
                        ...
                        if(is_new_handle_existing){
                            alert(rb_lang.anim_with_handle_exists);
                            return false;
                        }
        ...
        jQuery('#delete-current-animin, #delete-current-animout').click(function(){
            ...
            if(isOriginal || curAnimHandle == 'custom'){
                alert(rb_lang.default_animations_cant_delete);
            }else{
                if(confirm(rb_lang.really_delete_anim+' "'+curAnimText+'"?')){
        ...
        jQuery('.rename-current-css').click(function() {
            ...
            jQuery('#dialog_rename_css').dialog({
                ...
                buttons:{
                    'Rename':function(){
                        jQuery('#rs-rename-css').val(UniteAdminRb.sanitize_input(jQuery('#rs-rename-css').val()));
                        var new_css_name = jQuery('#rs-rename-css').val();
                        if(new_css_name != ''){
                            var curStyleName = jQuery('#layer_caption').val();
                            
                            var is_existing = UniteCssEditorRb.checkIfHandleExists(new_css_name);
                            var is_existing_old = UniteCssEditorRb.checkIfHandleExists(curStyleName);
                            
                            if(is_existing_old === false){ alert(rb_lang.css_orig_name_does_not_exists); return false; }
                            
                            if(is_existing !== false || curStyleName == new_css_name){ alert(rb_lang.css_name_already_exists); return false; } //cant rename to another existing name
                            
                            UniteCssEditorRb.renameStylesInDb(curStyleName, new_css_name);
                        }
                    }
                }
            });
        ...
        jQuery('.save-as-current-css').click(function() {
            ...
            jQuery('#dialog_save_as_css').dialog({
                ...
                buttons:{
                    'Save':function(){
                        jQuery('#rs-save-as-css').val(UniteAdminRb.sanitize_input(jQuery('#rs-save-as-css').val()));
                        var new_css_name = jQuery('#rs-save-as-css').val();
                        if(new_css_name != ''){
                            
                            var is_existing = UniteCssEditorRb.checkIfHandleExists(new_css_name);
                            if(is_existing !== false){ alert(rb_lang.css_name_already_exists); return false; } //cant rename to another existing name
                            
                            UniteCssEditorRb.saveStylesInDb(new_css_name, true, jQuery('#dialog_save_as_css'));
                        }
                    }
                }
            });
        ...
        jQuery('.delete-current-css').click(function() {
            if(confirm(rb_lang.delete_this_caption) === false) return false;
            
            var curStyleName = jQuery('#layer_caption').val();
            
            var is_existing = UniteCssEditorRb.checkIfHandleExists(curStyleName);
            if(is_existing === false){ alert(rb_lang.css_name_does_not_exists); return false; } //cant rename to another existing name
            
            //rename the css name or create new one depending on what is set
            UniteCssEditorRb.deleteStylesInDb(curStyleName, is_existing);
        ...
        jQuery('.save-current-css').click(function() {
            if(confirm(rb_lang.this_will_change_the_class)){
                var save_handle = jQuery('#layer_caption').val();
                var id = UniteCssEditorRb.checkIfHandleExists(save_handle);
                
                if(id !== false){ //update existing style
                    UniteCssEditorRb.saveStylesInDb(save_handle, false);
                }else{ //save as new
                    UniteCssEditorRb.saveStylesInDb(save_handle, true);
                }
            }
        });
            ...
            if(layer.style !== undefined){
                ...
                jQuery('#dialog-change-style-from-css').dialog({
                    buttons:{'OK':function(){
                        ...
                        if(!is_allowed){
                            alert(rb_lang.select_at_least_one_device_type);
                            return true;
                        }
    ...
    t.changeSlotBGs = function() {
        ...
        jQuery('#vid-rb-youtube-options').hide();
        jQuery('#vid-rb-vimeo-options').hide();
        ...
        switch(bbggtt){
            case "image":
                ...
                switch(gallery_type){
                    ...
                    case 'posts':
                    case 'specific_posts':
                        bgimg = rs_plugin_url+'/views/img/images/sources/post.png';
                    break;
                    case 'woocommerce':
                        bgimg = rs_plugin_url+'/views/img/images/sources/wc.png';
                    break;
                    case 'facebook':
                        bgimg = rs_plugin_url+'/views/img/images/sources/fb.png';
                    break;
                    case 'twitter':
                        bgimg = rs_plugin_url+'/views/img/images/sources/tw.png';
                    break;
                    case 'instagram':
                        bgimg = rs_plugin_url+'/views/img/images/sources/ig.png';
                    break;
                    case 'flickr':
                        bgimg = rs_plugin_url+'/views/img/images/sources/fr.png';
                    break;
                    case 'youtube':
                        bgimg = rs_plugin_url+'/views/img/images/sources/yt.png';
                    break;
                    case 'vimeo':
                        bgimg = rs_plugin_url+'/views/img/images/sources/vm.png';
                    break;
                }
                ...
                jQuery('#button_change_image').appendTo(jQuery('#tp-bgimagepssrc'));
            ...
            case "streamtwitterboth":
                ...
                bgimg = rs_plugin_url+'images/sources/tw.png';
                nextsh.find('.defaultimg, .slotslidebg').css({
                        backgroundImage:("url("+bgimg+")"),
                ...
                jQuery('#vid-rb-vimeo-options').show();
                jQuery('#vid-rb-youtube-options').show();
            ...
            case "streamyoutubeboth":
                jQuery('#streamvideo_cover').show();
                jQuery('#streamvideo_cover_both').show();
                bgimg = rs_plugin_url+'images/sources/yt.png';
            case "youtube":
                nextsh.find('.defaultimg, .slotslidebg').css({
                        backgroundImage:("url("+bgimg+")"),
                        backgroundPosition:'center center',
            ...
            case "streamvimeoboth":
                jQuery('#streamvideo_cover').show();
                jQuery('#streamvideo_cover_both').show();
                bgimg = rs_plugin_url+'images/sources/vm.png';
            case "vimeo":
                nextsh.find('.defaultimg, .slotslidebg').css({
                        backgroundImage:("url("+bgimg+")"),
                        backgroundPosition:'center center',
            ...
            case "streaminstagramboth":
                jQuery('#streamvideo_cover').show();
                jQuery('#streamvideo_cover_both').show();
                bgimg = rs_plugin_url+'images/sources/ig.png';
            case "html5":
                nextsh.find('.defaultimg, .slotslidebg').css({
                        backgroundImage:("url("+bgimg+")"),
                        backgroundPosition:'center center',
        ...
        for(var key in initArrFontTypes){
            if(initArrFontTypes[key].label == font){
                if(initArrFontTypes[key].type == 'googlefont'){
                    ...
                    if(jQuery('.rb-css-'+fontclass).length == 0){
                        //jQuery('head').append('<link class="rb-css-'+fontclass+'" href="//fonts.googleapis.com/css?family='+font+':'+gstring+'" rel="stylesheet" type="text/css">');
                        gfamilies.push(font+":"+gstring);
                        jQuery('body').append('<div style="display:none" class="rb-css-'+fontclass+'">RbSliderFont</div>');
    ...
    *****************************************************/
    var initHtmlFields = function(){
        ...
        jQuery('.rb-visibility-on-sizes input').click(function(){
            t.updateLayerFromFields();
        });
    ...
    var initButtons = function(){
        ...
        jQuery('#button_add_layer_image').click(function(){
            var targ = jQuery(this).data('isstatic') == true ? rb_lang.select_static_layer_image : rb_lang.select_layer_image,
                par = jQuery(this).data('isstatic') == true ? 'static' : null;
            
            UniteAdminRb.openAddImageDialog(targ,function(urlImage,imgid,imgwidth,imgheight){
        ...
        jQuery('body').on('click', '.addbutton-examples-wrapper a.rb-btn', function(){
            var data = {};
            data['static_styles'] = {};
            ...
            if(jQuery(this).hasClass('rb-withicon')){
            ...
            if(jQuery(this).hasClass('rb-hiddenicon')){
            ...
            if(jQuery(this).hasClass('rb-btn')){
            ...
            if(jQuery(this).hasClass('rb-uppercase')){
        ...
        var addSpecialButton = function(btn) {
            ...
            data['deformation']['background-color'] = UniteAdminRb.rgb2hex(btn.css('backgroundColor'));
            var bgOpacity = UniteAdminRb.getTransparencyFromRgba(btn.css('backgroundColor'));
            ...
            data['deformation']['border-color'] = UniteAdminRb.rgb2hex(btn.css('borderTopColor'));
            var borOpacity = UniteAdminRb.getTransparencyFromRgba(btn.css('borderTopColor'));
        ...
        jQuery('body').on('click', '.addbutton-examples-wrapper div.rb-burger', function(){            
        ...
        jQuery('body').on('click', '.addbutton-examples-wrapper span.rb-control-btn', function(){          
            var data = addSpecialButton(jQuery(this));          
            ...
            data['static_styles']['font-weight'] = jQuery(this).css('font-weight');
            data['static_styles']['color'] = UniteAdminRb.rgb2hex(jQuery(this).css('color'));
        ...
        jQuery('body').on('click', '.addbutton-examples-wrapper span.rb-scroll-btn', function(){
            var data = addSpecialButton(jQuery(this));          
    ...
    var setNewAnimFromObj = function(what, obj_v){
        ...
        RbSliderSettings.onoffStatus(jQuery('#masking-start'));
        RbSliderSettings.onoffStatus(jQuery('#masking-end'));
    ...
    var deleteAnimInDb = function(handle){
        ...
        UniteAdminRb.setErrorMessageID("dialog_error_message");
        ...
        if(handle != ''){
            ...
            UniteAdminRb.ajaxRequest("delete_custom_anim",handle,function(response){
    ...
    var renameAnimInDb = function(id, new_name){
        ...
        UniteAdminRb.ajaxRequest("update_custom_anim_name",data,function(response){
            //update html select (got from response)
            t.updateInitLayerAnim(response.customfull);
            updateLayerAnimsInput(response.customin, 'customin');
            updateLayerAnimsInput(response.customout, 'customout');
    ...
    var updateAnimInDb = function(handle, animObj, id){
        ...
        if(id === false){ //create new
            //insert in database
            UniteAdminRb.ajaxRequest("insert_custom_anim",animObj,function(response){
                //update html select (got from response)
                t.updateInitLayerAnim(response.customfull);
                updateLayerAnimsInput(response.customin, 'customin');
                updateLayerAnimsInput(response.customout, 'customout');
            ...
            //update to database
            UniteAdminRb.ajaxRequest("update_custom_anim",animObj,function(response){
    ...
    t.getHtmlLayerFromSerial = function(serial, isDemo){
        ...
        if(htmlLayer.length == 0)
            UniteAdminRb.showErrorMessage("Html Layer with serial: "+serial+" not found!");
    ...
    t.getLayer = function(serial, isDemo){
        ...
        if(!layer){
            return false;
            UniteAdminRb.showErrorMessage("getLayer error, Layer with serial: "+serial+" not found");
        }else{
            //modify some data
    ...
    t.getCurrentLayer = function(){
        if(selectedLayerSerial == -1){
            return false;
            UniteAdminRb.showErrorMessage(rb_lang.sel_layer_not_set);
            return(null);
        }
    ...
    t.makeLayerHtml = function(serial,objLayer,isDemo){
        ...
        switch(type){
            case "image":
                ...
                if(typeof ps_is_ssl_enabled != 'undefined' && ps_is_ssl_enabled){
                    objLayer.image_url = objLayer.image_url.replace('http:','https:');
                }
    ...
    t.reset_to_default_static_styles = function(layer, exclude, devices){
        ...
        if(layer.style !== undefined){
            ...
            var foundstyles = UniteCssEditorRb.getStyleSettingsByHandle(layer.style);
                ...
                if(foundstyles.params['color'] !== undefined){
                    if(exclude !== undefined && devices !== undefined){
                        if(jQuery.inArray('color', exclude) !== -1){
                            //set for specific devices now
                            layer['static_styles'] = t.setVal(layer['static_styles'], 'color', UniteAdminRb.rgb2hex(foundstyles.params['color']), false, devices);
                        }
                        if(jQuery.inArray(layout, devices) !== -1){
                            jQuery('#layer_color_s').val(UniteAdminRb.rgb2hex(foundstyles.params['color']));
                            //trigger color change on the colorpicker
                            jQuery('.ps-color-result').each(function(){
    ...
    t.updateLayer = function(serial,objData,del_certain){
        ...
        if(!arrLayers[serial]){
            UniteAdminRb.showErrorMessage("setLayer error, Layer with ID: "+serial+" not found");
            return(false);
        }
    ...
    t.updateReverseList = function() {
        clearTimeout(updateRbTimer);
        updateRbTimer =  setTimeout(function() {
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_xstart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_ystart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_xrotate_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_yrotate_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_zrotate_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_scale_xstart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_scale_ystart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_skew_xstart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_skew_ystart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#mask_anim_xstart_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#mask_anim_ystart_reverse'));

            RbSliderSettings.onoffStatus(jQuery('#layer_anim_xend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_yend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_xrotate_end_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_yrotate_end_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_anim_zrotate_end_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_scale_xend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_scale_yend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_skew_xend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#layer_skew_yend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#mask_anim_xend_reverse'));
            RbSliderSettings.onoffStatus(jQuery('#mask_anim_yend_reverse'));
        },100);
    }
    ...
    t.updateCurrentLayer = function(objData,del_certain){
        ...
        if(!arrLayers[selectedLayerSerial]){
            UniteAdminRb.showErrorMessage("error! the layer with serial: "+selectedLayerSerial+" don't exists");
            return(false);
        }
    ...
    var addLayer = function(objLayer, isInit, isDemo, skipScroller){
        ...
        //set Loop Animations
        objLayer.loop_animation = objLayer.loop_animation   || "disabled";
        ...
        if (objLayer.type == 'video' &&
            typeof(objLayer.video_width) == 'undefined' &&
            typeof(objLayer.video_data.width) !== 'undefined'
        ) objLayer.video_width = objLayer.video_data.width;
    ...
    var deleteLayerFromObject = function(serial){
        ...
        if(flagFound == false)
            UniteAdminRb.showErrorMessage("Can't delete layer, serial: "+serial+" not found");
    ...
    t.updateHtmlLayerCorners = function(htmlLayer,objLayer){
        ...
        var ncch = htmlLayer.outerHeight(),
            ...
            bgOpacity = UniteAdminRb.getTransparencyFromRgba(htmlLayer.css('backgroundColor'));
        bgOpacity = bgOpacity === false ? 1 : bgOpacity;
    ...
    */
    ...
    t.updateLayerFromFields_Core = function(){
        ...
        if(selectedLayerSerial == -1) return(false);        
        UniteCssEditorRb.compare_to_original(); //compare style changes and mark elements depending on state
        ...
        objUpdate.x_origin_start = jQuery('#layer_2d_origin_x').val();
        objUpdate.y_origin_start = jQuery('#layer_2d_origin_y').val();
        objUpdate.x_origin_end = jQuery('#layer_2d_origin_x').val();
        objUpdate.y_origin_end = jQuery('#layer_2d_origin_y').val();            
        ...
        objUpdate['deformation']['x'] = 0;
        objUpdate['deformation']['y'] = 0;
    ...
    var updateSubStyleParameters = function(objLayer, reset_full) {
        ...
        var fullstyles = UniteCssEditorRb.getStyleSettingsByHandle(objLayer["style"]);
        ...
        if(objLayer.deformation != undefined && styles !== undefined){
            ...
            if (nix(objLayer['deformation']['background-color']) || reset) {
                var hex = !nix(styles['background-color']) ? UniteAdminRb.rgb2hex(styles['background-color']) : "transparent",
                    transparency = !nix(styles['background-color']) ? UniteAdminRb.getTransparencyFromRgba(styles['background-color']) : 1;
            ...
            if (nix(objLayer['deformation']['border-color']) || reset)
                objLayer['deformation']['border-color'] = !nix(styles['border-color']) ? UniteAdminRb.rgb2hex(styles['border-color']) : "transparent";
        ...
        RbSliderSettings.onoffStatus(jQuery('#hover_allow'));
        ...
        if(objLayer.deformation != undefined){
            ...
            RbSliderSettings.onoffStatus(jQuery('#css_font-style'));
    ...
    var updateLayerFormFields = function(serial){
        ...
        jQuery('#layer_text').val(UniteAdminRb.stripslashes(objLayer.text));               
        ...
        RbSliderSettings.onoffStatus(jQuery('#hover_allow'));
        RbSliderSettings.onoffStatus(jQuery('#visible-desktop'));
        RbSliderSettings.onoffStatus(jQuery('#visible-notebook'));
        RbSliderSettings.onoffStatus(jQuery('#visible-tablet'));
        RbSliderSettings.onoffStatus(jQuery('#visible-mobile'));
        RbSliderSettings.onoffStatus(jQuery('#layer_on_slider_hover'));
        ...
        RbSliderSettings.onoffStatus(jQuery('.rs-proportion-check'));
        RbSliderSettings.onoffStatus(jQuery('.rs-linebreak-check'));
        ...
        RbSliderSettings.onoffStatus(jQuery("#layer_hidden"));
        RbSliderSettings.onoffStatus(jQuery("#layer_resizeme"));
        RbSliderSettings.onoffStatus(jQuery("#layer_resize-full"));
        RbSliderSettings.onoffStatus(jQuery("#layer_resp_offset"));
        RbSliderSettings.onoffStatus(jQuery("#layer-seo-optimized"));
    ...
    t.remove_action = function(o){
        if(confirm(rb_lang.remove_this_action)){
            o.closest('li').remove();
            t.updateLayerFromFields();
        }
    }
                        ...
                        switch(clayers[key]['layer_action']['action'][a]){
                            ...
                            case 'toggle_class':
                                ...
                                if(current_layer.unique_id == target_layer){
                                    ...
                                    switch(clayers[key]['layer_action']['action'][a]){
                                        case 'start_in':
                                            act = rb_lang.start_layer_in;
                                        break;
                                        case 'start_out':
                                            act = rb_lang.start_layer_out;
                                        break;
                                        case 'start_video':
                                            act = rb_lang.start_video;
                                        break;
                                        case 'stop_video':
                                            act = rb_lang.stop_video;
                                        break;
                                        case 'toggle_layer':
                                            act = rb_lang.toggle_layer_anim;
                                        break;
                                        case 'toggle_video':
                                            act = rb_lang.toggle_video;
                                        break;
                                        case 'simulate_click':
                                            act = rb_lang.simulate_click;
                                        break;
                                        case 'toggle_class':
                                            act = rb_lang.toggle_class;
                                        break;
                                    }
                                    
                                    jQuery('.layer_action_add_template').before('<li class="layer_is_triggered layer_action_wrap">'+rb_lang.layer_action_by+' <a href="javascript:UniteLayersRb.setLayerSelected(\''+key+'\');void(0);">'+clayers[key]['alias']+'</a> '+rb_lang.due_to_action+' '+act+'</li>');
                                }
                            break;
                        }
                    }
    ...
    t.setLayerSelected = function(serial,videoRefresh){
        ...
        UniteCssEditorRb.updateCaptionsInput(initArrCaptionClasses);
...
//======================================================
    ...
    var moveLayer = function(serial,dir,step){
        ...
        switch(dir){
            ...
            break;
            default:
                UniteAdminRb.showErrorMessage("wrong direction: "+dir);
                return(false);
            break;
        }
...
//======================================================
    ...
    var changeEndStaticFunctions = function(){
        ...
        jQuery('#layer_static_start').each(function(){
            ...
            jQuery("#layer_static_end").append('<option value="last">'+rb_lang.last_slide+'</option>');
