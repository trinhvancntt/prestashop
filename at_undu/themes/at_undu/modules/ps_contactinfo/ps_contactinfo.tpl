...
<div class="block-contact block links accordion_small_screen wrapper">
  <div class="title clearfix hidden-sm-down" data-target="#footer_block_contact" data-toggle="collapse">
    <span class="h4 text-uppercase title_block">{l s='Store information' d='Shop.Theme.Global'}</span>
  ...
  <ul class="collapse" id="footer_block_contact">
    <li class="address"><i class="fa fa-map-marker"></i><span>{$contact_infos.address.address1 nofilter}</span></li>
