  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title h6" id="myModalLabel"><i class="material-icons rtl-no-flip">&#xE876;</i>{l s='Product successfully added to your shopping cart' d='Shop.Theme.Checkout'}</h4>
      </div>
          ...
          <div class="col-xs-12 divide-right">
            <div class="row">
              ...
              <div class="col-sm-7 col-xs-12">
                ...
                {/foreach}
                <p>{l s='Quantity:' d='Shop.Theme.Checkout'}&nbsp;<strong>{$product.cart_quantity}</strong></p>
              </div>
            </div>
          </div>
          <div class="col-xs-12">
