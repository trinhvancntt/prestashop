				...
				{if $is_active}
					...
					<div class="blog-meta">
						...
						<span class="blog-author">
							<span class="ti-user"></span> <span>{l s='Posted By' d='Shop.Theme.Global'}: </span>
						...
						<span class="blog-cat"> 
							<span class="ti-layers-alt"></span> <span>{l s='In' d='Shop.Theme.Global'}: </span> 
						...
						<span class="blog-created">
							<span class="ti-calendar"></span> <span>{l s='On' d='Shop.Theme.Global'}: </span> 
						...
						<span class="blog-ctncomment">
							<span class="ti-comments"></span> <span>{l s='Comment' d='Shop.Theme.Global'}:</span> 
							{$blog_count_comment|intval}
						</span>
						{/if}
						{if isset($blog->hits)&&$config->get('item_show_hit','1')}
						<span class="blog-hit">
							<span class="ti-heart"></span> <span>{l s='Hit' d='Shop.Theme.Global'}:</span>
							{$blog->hits|intval}
						</span>
						{/if}
					</div>
