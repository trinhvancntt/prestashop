      ...
      <div class="images-container">
        {block name='product_cover_thumbnails'}
          ...
          {block name='product_cover'}
            ...
            {else}
              <img id="zoom_product" data-type-zoom="" class="js-qv-product-cover img-fluid" src="{$urls.no_picture_image.bySize.large_default.url}" alt="{$product.cover.legend}" title="{$product.cover.legend}" itemprop="image">
            {/if}
...
{/block}
                            </div><div class="pb-right-column  pb_column col-xl-6 col-lg-6 col-md-5 col-sm-12 col-xs-12 col-sp-12"><div class="leo-more-cdown" data-idproduct="{$product.id_product}"></div>
