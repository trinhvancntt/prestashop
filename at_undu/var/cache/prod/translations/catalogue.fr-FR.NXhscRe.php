...
Thanks for your patience.' => 'Notre boutique est en cours de mise à jour, nous revenons rapidement ! Merci pour votre patience.',
  ...
  array (
    ...
    'Register' => 'Registre',
    'Existing Account Login' => 'Connexion au compte existant',
    'Login to your account' => 'Connectez-vous à votre compte',
    'Email Address' => 'Adresse électronique',
    'Remember Me' => 'Souviens-toi de moi',
    'Forgot Password' => 'Mot de passe oublié',
    'No account? Create one here' => 'Pas de compte? En créer un ici',
    'Reset Password' => 'Réinitialiser le mot de passe',
    'New Account Register' => 'Nouveau compte s\'inscrire',
    'First Name' => 'Prénom',
...
[1]Pour les services :[/1] J\'accepte le lancement de la prestation de service et je reconnais perdre mon droit de révocation dès que la prestation est entièrement exécutée.',
  ...
  array (
    ...
    'Product Multi Layout' => 'Mise en page multi produit',
    ...
    'min' => 'moi',
    'sec' => 'seconde',
    'View all in instagram' => 'Voir tout dans Instagram',
    ...
    'hit' => 'frappé',
    'In' => 'Dans',
    'Sorry, We are updating data, please come back later!!!!' => 'Désolé, nous mettons à jour les données, veuillez revenir plus tard.!!!!',
    'On' => 'Sur',
    'No products at this time.' => 'Aucun produit pour le moment.',
    'No slide at this time.' => 'Aucune diapositive pour le moment.',
    '%s' => '%s',
    'Language' => 'Langue',
    'Currency' => 'Devise',
    'View my customer account' => 'Voir mon compte client',
    ...
    'December' => 'Décembre',
    'Childrens' => 'Enfants',
    'Recent blog posts' => 'Articles de blog récents',
    ...
    'RSS' => 'RSS',
    'Please enable JavaScript to view the.' => 'S\'il vous plaît activer JavaScript pour voir le.',
    'Comments powered by Disqus.' => 'Commentaires gérés par Disqus.',
    'Showing %start% - %showing% of %total% items' => 'Montrer %start% - %showing% de %total% articles',
    'Showing %start% - %showing% of 1 item' => 'Montrer %start% - %showing% de 1 article',
    'Like This' => 'Comme ça',
    'Twitter' => 'Twitter',
    ...
    'Rating' => 'Évaluation',
    'Reviews' => 'Avis',
    'Add Reviews' => 'Ajouter Commentaires',
    ...
    '(There are %s other product in the same category)' => '(Il y a %s autre produit dans la même catégorie)',
    '(There are %s other products in the same category)' => '(Il y %s d\'autres produits dans la même catégorie)',
    '[1]%phone%[/1]' => '[1]%phone%[/1]',
    '[1]%fax%[/1]' => '[1]%fax%[/1]',
    '[1]%email%[/1]' => '[1]%email%[/1]',
    ...
    'Call:' => 'Appel:',
    'Connect Online' => 'Connecter en ligne',
    'Newsletter sign up!' => 'Inscription à la newsletter!',
    'Just start searching...' => 'Il suffit de commencer à chercher ...',
    'Connect and follow' => 'Connectez-vous et suivez',
    'All sale products' => 'Tous les produits',
